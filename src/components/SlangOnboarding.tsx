            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  <span className={cn("text-xs", meaning.length >= 10 ? "text-green-500" : "text-gray-400")}>
                    {meaning.length}/10
                  </span>
                </div>
              ...
              <div>
                ...
                <div className="text-right text-xs mt-1">
                  <span className={cn(example.length >= 5 ? "text-green-500" : "text-gray-400")}>
                    {example.length}/5
                  </span>
                </div>
              </div>
          ...
          >
            ...
            <div className="space-y-4 max-w-sm mx-auto relative">
              ...
              {[
                ...
                <div key={idx} className="flex items-center gap-4 bg-gray-50 border border-gray-100 p-4 rounded-xl">
                  ...
                  <span className={cn("font-medium", reviewChecks[idx] ? "text-gray-900" : "text-gray-400")}>
                    {text}
                  </span>
                </div>
              ))}
            ...
            {reviewError && (
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-red-600 text-sm text-center">
                ...
                {reviewError}
                <button onClick={() => setStep(3)} className="block mt-4 mx-auto underline text-red-500 hover:text-red-700">
        ...
        return (
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-32 h-32 mx-auto bg-gradient-to-br from-amber-300 to-amber-600 rounded-3xl rotate-12 flex items-center justify-center shadow-2xl shadow-amber-200 mb-8">
                <div className="w-28 h-28 bg-white/20 backdrop-blur-sm rounded-2xl -rotate-12 flex items-center justify-center border border-white/30">
              ...
              <p className="text-amber-500 font-bold text-xl mb-8">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 mb-8">
                ...
                <div className="flex justify-between text-gray-900 font-bold mb-2">
