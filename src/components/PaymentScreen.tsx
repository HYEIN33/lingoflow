      ...
      >
        ...
        <div className="p-8 grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="flex items-baseline gap-1 mb-6">
              <span className="text-3xl font-black bg-gradient-to-r from-blue-600 to-indigo-500 bg-clip-text text-transparent">¥{isYearly ? '28' : '48'}</span>
            ...
            >
              <div className="border-t border-gray-100 pt-8">
                ...
                <button
                  ...
                  onClick={handlePay}
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-200 disabled:to-gray-200 disabled:text-gray-400 text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-200/50 hover:shadow-xl hover:shadow-blue-300/50"
                >
