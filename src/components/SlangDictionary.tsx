    ...
    <div className="mt-3 pt-3 border-t border-gray-100">
      ...
      {comments.length > 5 && !showAll && (
        <button
          ...
          className="text-xs text-violet-500 hover:text-violet-600 font-medium flex items-center gap-0.5 mb-2"
        >
      ...
      {auth.currentUser && (
        <div className="flex gap-2 mt-1">
          <input
            ...
            className="flex-1 text-xs bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-1.5 outline-none focus:ring-1 focus:ring-violet-500/50"
          />
          <button
            onClick={handleSubmitComment}
            disabled={!commentText.trim() || isSubmitting}
            className="p-1.5 bg-violet-500 text-white rounded-lg hover:bg-violet-600 disabled:opacity-40 transition-colors"
          >
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSearch} className="relative">
        <input
          ...
          className="w-full bg-white/40 backdrop-blur-md border border-white/50 rounded-2xl py-4 pl-12 pr-4 outline-none focus:ring-2 focus:ring-violet-500/50 transition-all shadow-sm"
        />
        ...
        <button
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 bg-violet-500 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-violet-600 disabled:opacity-50 transition-colors"
        >
        ...
        <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {recentSlangs.map((slang) => (
                  <button
                    ...
                    className="px-3 py-1.5 bg-white/60 border border-white/60 rounded-xl text-sm font-medium text-gray-700 hover:bg-violet-50 hover:border-violet-200 hover:text-violet-500 transition-colors"
                  >
                    {slang.term}
                  </button>
                ))}
          ...
          {auth.currentUser && (
            <button
              ...
              className="text-sm text-violet-500 hover:text-violet-600 font-medium flex items-center gap-1"
            >
      ...
      {searchTerm && !isSearching && !currentSlang && !showAddForm && searchResults.length === 0 && (
        ...
        >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-violet-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-violet-600 transition-colors shadow-md shadow-violet-200"
          >
      ...
      {currentSlang && (
        <div className="space-y-6">
          ...
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-violet-400 via-fuchsia-300 to-amber-500" />
            <div className="min-w-0">
            ...
            <div className="flex items-center gap-2 shrink-0">
              {onTryTranslate && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-fuchsia-400 bg-violet-50 hover:bg-violet-100 px-3 py-2 rounded-xl text-sm font-bold transition-all hover:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2"
                >
              ...
              {!showAddForm && (
                <button
                  onClick={() => setShowAddForm(true)}
                  className="flex items-center gap-1.5 text-violet-500 bg-violet-50 hover:bg-violet-100 px-3 py-2 rounded-xl text-sm font-bold transition-all hover:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2"
                >
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-gradient-to-br from-violet-400 to-fuchsia-400 rounded-xl flex items-center justify-center text-white font-black text-sm shadow-lg shadow-violet-200/50">
                      {index + 1}
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-7 h-7 bg-violet-50 rounded-full flex items-center justify-center text-violet-500 font-bold text-xs">
                      ...
                      <div>
                        ...
                        {meaning.authorTitle && (
                          <p className="text-[10px] text-violet-500 font-bold">{meaning.authorTitle}</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                {meaning.example && (
                  <div className="bg-gray-50 rounded-2xl p-4 sm:p-5 mb-5 border-l-4 border-violet-400">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  <div className="flex items-center gap-1.5">
                    ...
                    <motion.button
                      ...
                      className={cn(
                        "flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2",
                        upvotedMeanings.has(meaning.id)
                          ? "bg-violet-100 text-violet-600 shadow-sm"
                          : "bg-gray-100 text-gray-600 hover:bg-violet-50 hover:text-violet-500"
                      )}
                    >
                  ...
                  <button
                    ...
                    className="p-2 text-gray-300 hover:text-violet-500 transition-all rounded-xl hover:bg-violet-50 disabled:opacity-50"
        ...
        {showAddForm && (
          ...
          >
            <form onSubmit={handleSubmitMeaning} className="bg-white/60 backdrop-blur-md border border-white/60 rounded-3xl p-6 shadow-sm space-y-4">
              ...
              <div className="bg-violet-50/80 border border-violet-100 rounded-xl p-3 text-xs text-gray-600 space-y-1.5">
                <p className="font-bold text-violet-600 text-sm">{uiLang === 'zh' ? '参考示例 💡' : 'Example for reference 💡'}</p>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-white/50 border border-white/50 rounded-xl p-3 outline-none focus:ring-2 focus:ring-violet-500/50 min-h-[100px] resize-none"
                  required
                />
                {isLoadingSuggestion && (
                  <span className="flex items-center gap-1 text-xs text-violet-400 mt-1">
                ...
                <AnimatePresence>
                  {aiSuggestion && !isLoadingSuggestion && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -4 }}
                      className="mt-2 bg-violet-50 border border-violet-200 rounded-xl p-3 cursor-pointer hover:bg-violet-100 transition-colors group"
                    ...
                    >
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-[10px] text-blue-400 group-hover:text-violet-500 shrink-0 mt-0.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <button
                    ...
                    className="text-xs text-violet-500 hover:text-violet-600 font-medium flex items-center gap-1 disabled:opacity-50"
                  >
                ...
                <textarea
                  ...
                  className="w-full bg-white/50 border border-white/50 rounded-xl p-3 outline-none focus:ring-2 focus:ring-violet-500/50 min-h-[80px] resize-none"
                />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    disabled={!!audioFile}
                    className="w-full bg-white/50 border border-white/50 rounded-xl p-3 outline-none focus:ring-2 focus:ring-violet-500/50 disabled:opacity-50"
                  >
                ...
                <div>
                  ...
                  <label className="flex items-center justify-center gap-2 bg-white/50 border border-dashed border-gray-300 rounded-xl p-3 cursor-pointer hover:border-violet-400 hover:bg-violet-50/30 transition-all">
                    <input 
                      type="file" 
                      accept="audio/*" 
                      ...
                      className="hidden" 
                    />
                    <Mic className={cn("w-4 h-4", audioFile ? "text-violet-500" : "text-gray-400")} />
                    <span className={cn("text-xs truncate max-w-[120px]", audioFile ? "text-violet-500 font-medium" : "text-gray-500")}>
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <label className="flex-1 flex items-center justify-center gap-2 bg-white/50 border border-dashed border-gray-300 rounded-xl p-4 cursor-pointer hover:border-violet-400 hover:bg-violet-50/30 transition-all">
                    <input 
                      type="file" 
                    ...
                    />
                    {mediaFile ? (
                      <span className="text-sm text-violet-500 font-medium truncate max-w-[200px]">{mediaFile.name}</span>
                    ) : (
                      <>
              ...
              <div className="bg-violet-50/50 border border-violet-100 rounded-xl p-3 text-sm text-blue-800 flex items-start gap-2">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-violet-500 text-white px-6 py-2 rounded-xl text-sm font-medium hover:bg-violet-600 disabled:opacity-50 transition-colors"
                >
