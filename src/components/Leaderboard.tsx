          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h4 className="text-gray-900 font-bold truncate flex items-center gap-2">
                {user.username}
                {user.id === currentUserId && <span className="text-[10px] bg-blue-600 text-white px-2 py-0.5 rounded-full font-bold shadow-sm">YOU</span>}
              </h4>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-md ${
                ...
                index === 1 ? 'bg-gradient-to-br from-blue-400 to-indigo-400' :
